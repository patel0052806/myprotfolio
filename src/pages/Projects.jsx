...
import { Github, ExternalLink, Folder, Code2, Globe, Database, Sparkles } from 'lucide-react';

export default function Projects() {
  
  // UPDATED DATA: Added Gen-Z Decoder at the top
  const projects = [
    { 
      _id: 0, 
      title: 'Gen-Z Decoder', 
      desc: 'A fun and interactive dictionary application that helps users decode and understand popular Gen-Z slang. Built with a dedicated Node.js backend and a modern React frontend.', 
      tags: ['React', 'Node.js', 'Tailwind', 'Full Stack'], 
