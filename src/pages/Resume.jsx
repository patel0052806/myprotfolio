            ...
            <section>
              ...
              <div className="space-y-4 text-sm">
                <div>
                    ...
                    <p className="text-slate-400">React.js, Tailwind, HTML5, CSS3, JavaScript (ES6+)</p>
                </div>
                <div>
                    <span className="text-cyan-400 block font-semibold mb-1">Backend</span>
                    <p className="text-slate-400">Node.js, Express.js, PHP</p>
                </div>
                <div>
                    <span className="text-cyan-400 block font-semibold mb-1">Database</span>
                    <p className="text-slate-400">MongoDB, MySQL</p>
                </div>
                <div>
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                {/* Project 1: Gen-Z Decoder (NEW) */}
                <div className="relative pl-6 border-l border-slate-700">
                    <div className="absolute -left-[5px] top-1 w-2.5 h-2.5 bg-yellow-500 rounded-full"></div>
                    <h4 className="text-xl font-bold text-slate-200">Gen-Z Decoder</h4>
                    <span className="inline-block bg-yellow-900/30 text-yellow-400 text-xs px-2 py-0.5 rounded mb-2">Full Stack (Node + React)</span>
                    <ul className="list-disc ml-4 text-slate-400 text-sm space-y-1 mt-2 mb-3">
                        <li>Developed an interactive dictionary app to decode Gen-Z slang using a dedicated <strong>Node.js</strong> backend.</li>
                        <li>Implemented a responsive frontend with <strong>React</strong> and <strong>Tailwind CSS</strong> for a smooth user experience.</li>
                    </ul>
                    <div className="flex gap-4 text-sm">
                         <a href="https://gen-z-decoder.vercel.app/" target="_blank" className="flex items-center gap-1 text-cyan-400 hover:text-white transition"><ExternalLink size={14}/> Live Demo</a>
                         <a href="https://github.com/patel0052806/gen-z-decoder" target="_blank" className="flex items-center gap-1 text-slate-400 hover:text-white transition"><Github size={14}/> GitHub Repo</a>
                    </div>
                </div>
                ...
                <div className="relative pl-6 border-l border-slate-700">
                    ...
                    <ul className="list-disc ml-4 text-slate-400 text-sm space-y-1 mt-2 mb-3">
                        ...
                        <li>Implemented secure user authentication and dynamic message retrieval.</li>
                    </ul>
                    <div className="flex gap-4 text-sm">
                ...
                <div className="relative pl-6 border-l border-slate-700">
                    ...
                    <ul className="list-disc ml-4 text-slate-400 text-sm space-y-1 mt-2 mb-3">
                        ...
                        <li>Implemented secure user authentication (JWT) and a responsive UI.</li>
                    </ul>
                    <div className="flex gap-4 text-sm">
